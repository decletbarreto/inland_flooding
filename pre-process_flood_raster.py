...
def preprocess_flood_raster(flood_event_id):
    import arcpy
    import datetime
    import glob
    import os
    ...
    overlay_analysis_gdb = "C:\\Users\\jdeclet-barreto\\Documents\\EPIF\\data\\overlay_analysis\\Event_" + Flood_Event_ID + ".gdb"
    ...
    arcpy.gp.ExtractByAttributes_sa(Raster_red_band_lyr,   '"Value" =255', Raster_floodwater_in_red_band)
...
preprocess_flood_raster(flood_event_id)
