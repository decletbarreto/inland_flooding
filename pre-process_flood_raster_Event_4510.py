...
def preprocess_flood_raster(flood_event_id,red_band_pixel_value_threshold):
    ...
    flood_rasters_dir= "d:\\UCS_projects\\EPIF\\data\\CFO\\flood_extent_rasters"
    ...
    # Local variables:
    FEMA_Flood_zones = "D:\\data\\FEMA_flood_hazard_areas.gdb\\FEMA_NFHL_100_500_year_flood_zones_NAD83"
    ...
    arcpy.CreateFileGDB_management("d:\\UCS_projects\\EPIF\\data\\overlay_analysis", "Event_" + Flood_Event_ID + ".gdb", "CURRENT")
    ...
    #accuracy assessment        
    #Process: Extract Unprojected Rapythonster by Attributes
...
flood_event_id=4510
red_band_pixel_value_threshold = 224
